...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://download.virtualbox.org/virtualbox/6.0.4/VBoxGuestAdditions_6.0.4.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
